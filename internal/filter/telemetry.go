...
func TraceGitWorktreeCreate(ctx context.Context, ref, worktreeDir, repoRemote, repoBranch, repoCommit string, fn func(ctx context.Context) error) error {
	...
	return telemetry.TelemeterFromContext(ctx).Collect(ctx, nil, TelemetryOpGitWorktreeCreate, attrs, func(ctx context.Context, _ log.Logger) error {
		return fn(ctx)
	})
}
...
func TraceGitWorktreesCreate(ctx context.Context, workingDir string, refCount int, repoRemote, repoBranch, repoCommit string, fn func(ctx context.Context) error) error {
	...
	return telemetry.TelemeterFromContext(ctx).Collect(ctx, nil, TelemetryOpGitWorktreesCreate, attrs, func(ctx context.Context, _ log.Logger) error {
		return fn(ctx)
	})
}
...
func TraceGitWorktreesCleanup(ctx context.Context, pairCount int, repoRemote string, fn func(ctx context.Context) error) error {
	...
	return telemetry.TelemeterFromContext(ctx).Collect(ctx, nil, TelemetryOpGitWorktreesCleanup, attrs, func(ctx context.Context, _ log.Logger) error {
		return fn(ctx)
	})
}
...
func TraceGitDiff(ctx context.Context, fromRef, toRef, repoRemote string, fn func(ctx context.Context) error) error {
	...
	return telemetry.TelemeterFromContext(ctx).Collect(ctx, nil, TelemetryOpGitDiff, attrs, func(ctx context.Context, _ log.Logger) error {
		return fn(ctx)
	})
}
